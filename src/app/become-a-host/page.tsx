...
const BecomeAHostPage: React.FC = () => {
  ...
  const isUserLoggedIn = useSelector((state: RootState) => state.user?.loggedIn ?? false);
  const isHostAlready = useSelector((state: RootState) => state.user?.me?.host ?? false);
      ...
      <div className="w-full overflow-hidden">
        ...
        >
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-20">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              If you own or manage a property that aligns with our commitment to
              quality, sustainability, and guest satisfaction, we invite you to
        ...
        >
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              Choose a plan that works best for your hosting needs. Switch between plans anytime as your business grows.
            </m.p>
              ...
              {PLANS.map((plan, idx) => (
                ...
                >
                  ...
                  <div className="mb-8">
                    <div className="flex items-end gap-1 mb-1">
                      <span className="text-4xl font-bold">
                        {formatPrice(checked ? plan.yearlyPrice : plan.monthlyPrice)}
          </span>
                  ...
                  <div className="mt-auto">
                    {isLoggedInAndNotHost ? (
                      <AddHost className={`w-full justify-center ${
                        plan.popular ? "bg-primary" : "bg-[#FFF1D7] text-primary hover:bg-primary hover:text-white"
                      }`} />
                    ) : isLoggedInAndHostAndGuest ? null : (
                      <BecomeAHost>
                        <div className={`w-full py-3 px-6 rounded-full font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer ${
                          plan.popular ? "bg-primary text-white" : "bg-[#FFF1D7] text-primary hover:bg-primary hover:text-white"
                        }`}>
                          Get Started
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto">
                Join our community of exceptional hosts who are redefining hospitality in Nigeria
              </p>
            </m.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
              ...
              >
                <div className="bg-white/20 w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
                  <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 21H21M3 21V11L12 2L21 11V21M3 21H9V15H15V21H21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-white mb-4">Homeowners</h3>
                <p className="text-white/80 leading-relaxed">
                  If you own a well-maintained, stylish, and comfortable property in a prime location, 
                  we'd love to hear from you. Whether it's a modern urban apartment, a charming 
                  countryside villa, or a coastal retreat, we're eager to explore partnership possibilities.
                </p>
              </m.div>
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Property Managers</h3>
                <p className="text-white/80 leading-relaxed">
                  If you manage a portfolio of properties that meet our high standards, partnering 
                  with Sojourn can open up new opportunities to showcase your collection to a diverse 
        ...
        >
          <div className="max-w-7xl mx-auto">
            <m.div
              ...
              className="text-center mb-16"
            >
              <span className="text-primary font-medium mb-4 block">Simple Steps</span>
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                How to <span className="text-primary">Become</span> a Host
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Join our community of exceptional hosts who are redefining hospitality in Nigeria. 
                Follow these simple steps to start your hosting journey.
              </p>
            </m.div>
            ...
            >
              ...
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-primary text-white w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-xl transform rotate-45 group-hover:rotate-0 transition-transform duration-500">
                  <span className="transform -rotate-45 group-hover:rotate-0 transition-transform duration-500">1</span>
                </div>
                <div className="text-center mt-6">
                  <div className="bg-primary/10 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 transform group-hover:scale-110 transition-transform duration-500">
                    <svg className="w-8 h-8 text-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M15 16L20 21M20 16L15 21M4 21C4 17.134 7.13401 14 11 14C12.0736 14 13.0907 14.2417 14 14.6736M15 7C15 9.20914 13.2091 11 11 11C8.79086 11 7 9.20914 7 7C7 4.79086 8.79086 3 11 3C13.2091 3 15 4.79086 15 7Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold mb-4">Create Your Account</h3>
                  <p className="text-gray-600">
                    Sign up and complete your profile with all necessary information to get started.
                  </p>
                </div>
              </m.div>
              ...
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-primary text-white w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-xl transform rotate-45 group-hover:rotate-0 transition-transform duration-500">
                  <span className="transform -rotate-45 group-hover:rotate-0 transition-transform duration-500">2</span>
                </div>
                <div className="text-center mt-6">
                  <div className="bg-primary/10 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 transform group-hover:scale-110 transition-transform duration-500">
                    <svg className="w-8 h-8 text-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-gray-600">
                    Add your property details, high-quality photos, and set your pricing strategy.
                  </p>
                </div>
              </m.div>
              ...
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-primary text-white w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-xl transform rotate-45 group-hover:rotate-0 transition-transform duration-500">
                  <span className="transform -rotate-45 group-hover:rotate-0 transition-transform duration-500">3</span>
                </div>
                <div className="text-center mt-6">
                  <div className="bg-primary/10 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 transform group-hover:scale-110 transition-transform duration-500">
                    <svg className="w-8 h-8 text-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-gray-600">
                    Complete our verification process to ensure trust and safety in our community.
                  </p>
                </div>
              </m.div>
              ...
              >
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-primary text-white w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-xl transform rotate-45 group-hover:rotate-0 transition-transform duration-500">
                  <span className="transform -rotate-45 group-hover:rotate-0 transition-transform duration-500">4</span>
                </div>
                <div className="text-center mt-6">
                  <div className="bg-primary/10 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 transform group-hover:scale-110 transition-transform duration-500">
                    <svg className="w-8 h-8 text-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-gray-600">
                    Welcome guests and start earning by providing exceptional hospitality experiences.
                  </p>
                </div>
              </m.div>
            </m.div>
        ...
        />
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-[#E7F4E7] rounded-2xl p-4 text-center">
                      <svg className="w-8 h-8 text-[#158215] mx-auto mb-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17 8C8 10 5 16 4 22M17 8C19.5 7.5 21.5 7.5 24 8M17 8V2M1 22H24M4 22C5 16 8 10 17 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      <p className="text-sm font-medium text-[#158215]">Environmental Impact</p>
                    </div>
                    <div className="bg-[#E7F4E7] rounded-2xl p-4 text-center">
                      <svg className="w-8 h-8 text-[#158215] mx-auto mb-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className="text-sm font-medium text-[#158215]">Social Responsibility</p>
                    </div>
                    <div className="bg-[#E7F4E7] rounded-2xl p-4 text-center">
                      <svg className="w-8 h-8 text-[#158215] mx-auto mb-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p className="text-sm font-medium text-[#158215]">Governance</p>
                    </div>
                  </div>
                </div>
              </m.div>
              ...
              >
                <span className="text-[#158215] font-medium mb-4 block">Our ESG Commitment</span>
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      We're committed to reducing our environmental footprint through sustainable practices 
                      and eco-friendly initiatives across our properties.
                    </p>
                  </m.div>
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      Creating positive change in local communities through job creation, 
                      cultural preservation, and inclusive hospitality practices.
                    </p>
                  </m.div>
                  ...
                  <m.div 
                    ...
                    className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all"
                  >
                    <h3 className="text-xl font-bold mb-2">Responsible Governance</h3>
                    <p className="text-gray-600">
                      Maintaining the highest standards of transparency, ethics, and accountability 
