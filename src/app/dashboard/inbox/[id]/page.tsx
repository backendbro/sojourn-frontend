...
export default function InboxContent() {
  ...
  const handleCloseDetails = () => {
    ...
    if (window.innerWidth < 768) {
      // On mobile, go back to chat view
      setMobileView("chat");
    } else {
      // On desktop, just hide the details panel
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-70px)] bg-gray-50 overflow-hidden">
      <div className="flex-1 flex overflow-hidden relative">
        {/* Inbox and Chat Section */}
        <div className="flex-1 flex flex-col overflow-hidden">
          {/* Inbox Header */}
          <div className="bg-white border-b border-gray-200 px-4 md:px-6 py-1 shadow-sm">
            <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div className="hidden md:block w-80 border-r border-gray-200 bg-white flex flex-col">
              {isLoading ? (
                <div className="p-4 space-y-4">
                  <Skeleton className="h-16 w-full" />
                  <Skeleton className="h-16 w-full" />
            ...
            <div
              className={`
                md:hidden absolute inset-0 bg-white flex flex-col
            ...
            <div
              className={`
                ...
                ${mobileView === "chat" || mobileView === "details" ? "flex" : "hidden md:flex"}
              `}
            >
              {selectedConversation ? (
                <>
