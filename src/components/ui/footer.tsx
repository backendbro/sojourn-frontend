    ...
    <footer className="bg-primary text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {/* Logo / Brand */}
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left space-y-3 sm:col-span-2 lg:col-span-1">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2.5 text-sm text-white/80">
        ...
        {/* Bottom bar */}
        <div className="mt-10 pt-6 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-white/70">
          <span>© {new Date().getFullYear()} Sojourn. All rights reserved.</span>
