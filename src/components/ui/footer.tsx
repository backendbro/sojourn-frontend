...
const Footer: React.FC = () => {
  return (
    <footer className="footer-section bg-primary text-white">
      <div className="container-regular max-w-7xl mx-auto px-4 py-8">
        {/* Top area: stack on mobile, 3 columns on md+ */}
        <div className="footer-grid grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start">
          {/* Logo / Brand */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-3">
            <Link
              href="/"
              className="footer-logo-link w-inline-block inline-block"
              aria-label="Home"
            >
              {/* keep your original class but constrain with small width utilities so it won't get huge */}
              <img
                src="/assets/logo/soj_white.svg"
                loading="lazy"
                alt="Brand"
                className="footer-logo w-24 md:w-28 h-auto"
              />
            </Link>
            <p className="text-sm max-w-xs leading-relaxed opacity-95">
              Simple stays, local hosts — book and earn with ease. Need help?
              Check support links or contact us.
            </p>
          </div>

          {/* Support & Company links grouped vertically on mobile */}
          <div className="footer-left-column flex flex-col sm:flex-row sm:gap-8 justify-center md:justify-start">
            <div className="footer-column mb-4 sm:mb-0">
              <div className="margin-bottom-16">
                <div className="detail text-white">Support</div>
              </div>
              <nav className="flex flex-col text-sm">
                <a href="/privacy-policy" className="footer-link block py-1">
                  Privacy policy
                </a>
                <a href="/terms-of-use" className="footer-link block py-1">
                  Terms of use
                </a>
                <Link href="/safety" className="footer-link block py-1">
                  Safety
                </Link>
              </nav>
            </div>
            ...
            <div className="footer-column">
              ...
              <nav className="flex flex-col text-sm">
                <a href="/about-us" className="footer-link block py-1">
                  About Us
                </a>
                <a href="/become-a-host" className="footer-link block py-1">
                  Become a host
                </a>
                <a href="/contact-us" className="footer-link block py-1">
                  Contact Us
                </a>
                <a href="/deals-and-offers" className="footer-link block py-1">
                  Deals and Offers
                </a>
              </nav>
            </div>
          ...
          <div className="footer-column flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <div className="footer-social-links flex gap-3">
              <a
                ...
                className="footer-social-link w-inline-block p-2 rounded-md bg-white/6 hover:bg-white/10"
                aria-label="Facebook"
              >
                <div className="footer-social w-embed">
                  {/* keep original svg but reduce to 20x20 for better fit */}
                  <svg
        ...
        {/* Bottom area */}
        <div className="footer-bottom mt-6 border-t border-white/20 pt-4 flex flex-col md:flex-row items-center md:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            >
              <img
                ...
                loading="lazy"
                alt="Brand"
                className="footer-logo w-20 md:w-24 h-auto"
              />
            </Link>
            <div className="footer-link-copy text-sm opacity-90">
