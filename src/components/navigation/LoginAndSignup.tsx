...
//           <div
//             role="button"
//             className="py-3 outline-none font-[700] border-0 ease duration-300 rounded-full px-4 hover:bg-red-50"
//           >
//             Login
//           </div>
//         </DialogTrigger>
...
function NavSignupGoogleButton({
  onToken,
  onError,
}: {
  onToken: (token: { access_token: string }) => void;
    ...
    <div className="hidden md:flex items-center shrink-0">
      ...
      >
        <DialogTrigger>
          <div
            role="button"
            className="py-3 outline-none font-[700] text-[15px] border-0 ease duration-300 rounded-full px-5 hover:bg-white/10 text-white min-h-[46px] flex items-center"
          >
            Login
          </div>
        </DialogTrigger>
        <DialogContent className="w-[calc(100vw-2rem)] sm:w-auto max-w-[420px] min-h-[50px] mx-auto">
          {googleMutation.isPending ? (
            <div className="w-full flex items-center justify-center">
              <Spinner size={35} color="red" />
            </div>
            ...
            <>
              ...
              <form
                autoComplete="off"
                className="w-full min-h-[250px] overflow-y-auto space-y-2 pb-8 sm:pb-10 px-3 sm:px-5"
                onSubmit={handleSubmit(guestLogin)}
              >
                {mutation.isError && (
                  <span className="text-primary font-semibold">
                ...
                <button
                  ...
                  className="border-0 outline-none rounded-full flex items-center justify-center w-full p-4 bg-primary text-white font-bold ease duration-300 hover:bg-red-800 disabled:opacity-70"
                >
                  {mutation.isPending ? <Spinner /> : <span>Login</span>}
                </button>
                {isGoogleAuthEnabled && (
                  <NavLoginGoogleButton
                    onToken={setUser}
                    onError={() =>
                      toast("Login Message", {
                        description: "Could not login at this time. Please try again.",
  ...
  return (
    <Dialog>
      <DialogTrigger>
          <div
          role="button"
          className="p-3 outline-none font-[700] text-[15px] border-0 ease duration-300 rounded-full px-5 hover:bg-white/10 text-white min-h-[46px] flex items-center"
        >
          Signup
        </div>
      </DialogTrigger>
          ...
          <>
            ...
            >
              ...
              <button
                ...
                className="border-0 outline-none rounded-full flex items-center justify-center w-full p-4 bg-primary text-white font-bold ease duration-300 hover:bg-red-800 disabled:opacity-70"
              >
                {signupMutation.isPending ? <Spinner /> : <span>Signup</span>}
              </button>
              {isGoogleAuthEnabled && (
                <NavSignupGoogleButton
                  onToken={setUser}
                  onError={() =>
                    toast("Signup Message", {
                      description: "Could not signup at this time. Please try again.",
