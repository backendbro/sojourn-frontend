...
const ProfileMenu = () => {
  ...
  return localLogin ? (
    <>
      {isOnHostsAndHostExists ? (
        <li className="block bg-secondary font-semibold md:hidden w-full ease duration-300 hover:bg-red-50 cursor-pointer list-none">
          <Link href="/" className="w-full h-full px-5 py-3 block min-h-[44px] flex items-center">
            <div className="flex items-center space-x-2">
              <span>Go to Guest</span>
        ...
        <>
          {isOnGuestAndHostExists ? (
            <li className="block bg-secondary md:hidden w-full ease duration-300 hover:bg-red-50 cursor-pointer list-none">
              <Link
                href="/hosts/dashboard/properties"
                className="w-full h-full px-5 py-3 block min-h-[44px] flex items-center"
              >
                <div className="flex items-center space-x-2">
                  <span>Go to Host</span>
                  <ArrowRight color="black" size={18} />
      ...
      {!isOnHosts ? (
        <li className="w-full border-b border-gray-100 list-none">
          <Link
            prefetch
            className="w-full h-full px-5 py-3 flex items-center gap-3 hover:bg-red-50 transition-colors"
            href="/dashboard/bookings"
          >
