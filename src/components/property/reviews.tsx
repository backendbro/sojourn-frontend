...
export default () => {
  ...
  return data && data?.length ? (
    <section className="w-full flex flex-col items-center px-3 sm:px-6 md:px-12 lg:px-20 min-h-[350px] sm:min-h-[450px] md:min-h-[600px] lg:min-h-[700px] py-10 sm:py-14 md:py-20 lg:py-24 bg-[#FFF1D7] justify-center">
      <h3 className="text-center sm:text-left font-semibold text-[22px] sm:text-[28px] md:text-[36px] lg:text-[48px] text-[#000000] font-sans max-w-[1400px] mx-auto w-full">
        <span className="text-primary">Stories</span> from Our Comfort
      </h3>
      <p className="font-semibold text-center sm:text-left text-sm sm:text-base md:text-lg lg:text-[24px] mt-1 sm:mt-2 text-[#000000] font-sans max-w-[1400px] mx-auto w-full">
        Here is what our visitors and guests have been saying
      </p>
