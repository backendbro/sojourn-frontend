...
import { useSelector } from "react-redux";
import { RootState } from "@/store";
import { getMessagesByGuestId, getTicketMessages } from "@/http/api";
import { Conversation } from "@/types/messages";
import MessageList from "@/components/messages/MessageList";
import ChatWindow from "@/components/messages/ChatWindow";
import ListingDetails from "@/components/messages/ListingDetails";
          ...
          <>
            {!showListingDetails && (
              <button
                ...
                className="hidden md:flex absolute right-4 top-4 z-30 bg-white border px-3 py-2 rounded-lg shadow text-sm"
              >
