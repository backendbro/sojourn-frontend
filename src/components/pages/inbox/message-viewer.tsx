...
export default ({ id }: { id: string }) => {
  ...
  return (
    <div className="w-full flex relative">
      <div
        className={`${messagesBoxWidth} md:h-[calc(100vh-280px)]  lg:h-[calc(100vh-222px)] translate-z-0 ease duration-300 relative`}
      >
        <div className="w-full relative h-full">
          <div className="w-full flex flex-col items-center">
            <div className="w-full border-b  border-b-gray-300 py-2 px-3 font-semibold capitalize flex items-center space-x-3 md:space-x-0 md:justify-between">
              <div className="w-1/2 md:w-4/6 flex items-center space-x-2">
                    ...
                    {m.host && (
                      <div className="w-full flex items-center justify-start">
                        <div className="min-w-[100px] max-w-[350px] md:max-w-[500px]  py-2 px-4 flex-col bg-[#F7F7F7] space-y-1 rounded-md">
                          ...
                          <p className="text-[14px] text-[#3F3F3F] font-semibold">
                            {m.message}
                          </p>
          ...
          <form
            onSubmit={onSubmit}
            className="w-full flex h-[55px] items-center p-2 bottom-0 border border-gray-400 bg-transparent rounded-md"
          >
            <textarea
              ...
              className="w-[85%] md:w-[92%] px-3 py-2 h-full overflow-hidden rounded-l-full font-semibold resize-none border-0 outline-none"
              placeholder="type your message here..."
            />
            <button
              disabled={!message}
              className="w-[15%] md:w-[8%] p-3 h-full  outline-none rounded-r-full  flex items-center justify-center"
            >
              {mutation.isPending ? (
