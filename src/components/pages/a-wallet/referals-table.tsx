...
export const columns: ColumnDef<Referal>[] = [
  ...
  },
  {
    ...
    header: () => <div> Last Name</div>,
    cell: ({ row }) => {
      return <div className="capitalize">{row.getValue("referalLastName")}</div>;
    },
  },
  {
    accessorKey: "amount",
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            >
              ...
              <DialogContent id="host-booking-receipt" className="md:min-w-[200px]">
                <ReferalViewer id={referal.id} />
              </DialogContent>
            </Dialog>
          </DropdownMenuContent>
...
export default () => {
  ...
  /* ------------------- gradient/card styles reused from BalanceCard ------------------- */
  ...
  return (
    <div className="w-full my-4">
      {/* Header: replaced the red strip with BalanceCard-style gradient */}
      <div style={rootStyle} className="mb-4">
        ...
        <div style={cardStyle} className="w-full flex flex-col md:flex-row md:items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center">
              <p className="text-white text-sm md:mr-4">Referral Balance:</p>
              <div className="font-bold text-white text-2xl md:text-3xl font-inter">
          ...
          <div className="mt-3 md:mt-0">
            <Dialog>
              <DialogTrigger asChild>
                <button
                  className="rounded-full font-[600] text-black px-4 py-2"
            ...
            {table.getRowModel().rows.map((row, idx: number) => {
              ...
              return (
                ...
                >
                    ...
                    <div className="w-full sm:hidden min-h-[50px]  flex flex-col rounded-xl overflow-hidden border-b">
                      <div className="w-full flex py-4 px-2 space-x-2">
                        ...
                        <div className="w-5/6 flex flex-col">
                          ...
                          <div className="w-full flex items-center justify-between">
                            <span className="text-xs font-semibold mt-1">
                              {referalType === "incoming" ? "Deposits" : "Withdrawal"}
                            </span>
                            <span className="text-xs font-semibold mt-1">
                              {humanize.relativeTime(new Date(date))}
                            </span>
                  ...
                  <DialogContent id="host-booking-receipt" className="md:min-w-[700px]">
                    <ReferalViewer id={row.original.id} />
                  </DialogContent>
                </Dialog>
              );
          ...
          <div className="hidden sm:flex items-center py-4">
            <div className="w-full md:w-1/4 space-x-2  mb-4 h-[40px] flex items-center justify-center py-4 border rounded-md border-gray-400">
              <input
                placeholder="Search by first name"
                value={
                  (table.getColumn("referalFirstName")?.getFilterValue() as string) ?? ""
                }
                onChange={(event) =>
                  table.getColumn("referalFirstName")?.setFilterValue(event.target.value)
                }
                className="w-2/3 placeholder:text-gray-400 outline-none border-0 bg-transparent pr-1 text-[16px]"
              />
              <Search color="#aaa" size={20} />
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="ml-auto bg-black  hover:bg-black">
                  <SlidersHorizontal color="white" className="ml-2 h-4 w-4" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end">
