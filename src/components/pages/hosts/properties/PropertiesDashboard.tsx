...
/* UI components imported from your old file */
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
export default function PropertiesDashboard(): JSX.Element {
  ...
  const [inspectionsRaw, setInspectionsRaw] = useState<any | null>(null);
  const [propertiesRaw, setPropertiesRaw] = useState<any | null>(null);
  const [hostId, setHostId] = useState<string | null>(null); // ADDED: store host id

  const client = useQueryClient();

  // mutation for updating activeStatus (activate/deactivate)
  ...
  // fallback to mock if backend empty (optional)
  const propsToRender = propertiesList.length > 0 ? propertiesList : [];
  ...
  const toggleActiveStatus = (property: any) => {
    ...
    const payload = {
      ...
      activeStatus:
        property.activeStatus === "active" ? "deactivated" : "active",
    };
              ...
              {!loading &&
                ...
                (visibleInspections.length === 0 ? (
                  ...
                  visibleInspections.map((ins: any) => {
                    ...
                    const statusApproved = ins.status === "approved";
                          ...
                          >
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem>
                                  <Link
                                    href={`/hosts/dashboard/properties/${id}`}
                                  ...
                                  >
                                    <Eye size={16} /> <span>View / Edit</span>
                                  </Link>
                                </DropdownMenuItem>
                                ...
                                {statusApproved ? (
                                  <>
                                    ...
                                    <div
                                      role="button"
                                      onClick={() => toggleActiveStatus(ins)}
                                      style={{
                                        display: "flex",
                                        padding: 8,
                                        alignItems: "center",
                                    ...
                                    >
                                      {mutation.isPending ? (
                                        <Spinner size={16} color="red" />
                                      ) : (
                                        <>
                                          <Power size={16} />
                                          <span>
                                            {ins.activeStatus === "active"
                                              ? "Deactivate"
                                              : "Activate"}
                                          </span>
                                        </>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                {prop.status === "approved" ? (
                                  <>
                                    ...
                                    <div
                                      role="button"
                                      onClick={() => toggleActiveStatus(prop)}
                                      style={{
                                        display: "flex",
                                        padding: 8,
                                        alignItems: "center",
